...
### MCP 生态系统
31 个 MCP 技能 + 26 个内置工具模块，覆盖文件操作、桌面自动化、Web 搜索、代码执行、PDF 生成、图像/视频处理、电商运营、财税办公等场景。
...
### 技能市场
- **30+ 内置技能** — 天气、邮件、PDF、二维码、翻译、股票、电商运营、财税办公、计时器、笔记、密码、图片处理、视频编辑、网页爬虫、代码沙箱、桌面自动化等
