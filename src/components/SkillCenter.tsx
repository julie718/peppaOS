...
const ICON_CLASSES: Record<string, string> = {
  ...
  ShieldCheck: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20',
  Wrench: 'bg-slate-500/10 text-slate-300 border-slate-500/20',
...
const PROFESSION_RECOMMENDATION_MAP: Record<string, string[]> = {
  ...
  trader: ['skill-cross-border-trade', 'skill-ecommerce-ops', 'skill-translator'],
  exporter: ['skill-cross-border-trade', 'skill-translator', 'skill-finance-office'],
  manufacturer: ['skill-manufacturing-qa', 'skill-finance-office'],
  factory: ['skill-manufacturing-qa', 'skill-executive-ops'],
  quality: ['skill-manufacturing-qa'],
  realtor: ['skill-property-ops', 'skill-cad-drafting', 'skill-legal-casework'],
  property: ['skill-property-ops', 'skill-cad-drafting'],
  insurance: ['skill-insurance-advisor', 'skill-sales-customer-ops'],
  creator: ['skill-content-ops', 'skill-design-studio-pack', 'skill-video-editor'],
  marketer: ['skill-content-ops', 'skill-sales-customer-ops'],
  product: ['skill-product-project-ops', 'skill-design-studio-pack'],
  project: ['skill-product-project-ops', 'skill-executive-ops'],
  assistant: ['skill-admin-assistant', 'skill-pdftools', 'skill-email-assistant'],
  admin: ['skill-admin-assistant', 'skill-pdftools', 'skill-notes'],
  procurement: ['skill-procurement-supply-chain', 'skill-finance-office'],
  supply: ['skill-procurement-supply-chain', 'skill-logistics-warehouse'],
  analyst: ['skill-data-bi', 'skill-finance-office'],
  data: ['skill-data-bi', 'skill-code-sandbox'],
  logistics: ['skill-logistics-warehouse', 'skill-cross-border-trade'],
  warehouse: ['skill-logistics-warehouse', 'skill-ecommerce-ops'],
  streamer: ['skill-live-commerce', 'skill-content-ops', 'skill-video-editor'],
