...
export interface PeppaConnection {
  from: string;
  to: string;
  bandwidth: number;
}
...
export function generateDemoNodes(): PeppaNode[] {
...
export function generateDemoConnections(nodes: PeppaNode[]): PeppaConnection[] {
