/**
 * Peppa Skill Generator — LLM-driven MCP server package generation.
 *
...
const GENERATE_PROMPT = `You are a Skill SDK generator for Peppa. Your job is to create an MCP (Model Context Protocol) server tool with a fully implemented, executable handler function.

## Context
Peppa has learned a repeatable workflow by observing tool execution patterns. You need to encode this knowledge as a standalone MCP tool with REAL, EXECUTABLE code.
 ...
 * Auto-generated Peppa Skill: {skillName}
