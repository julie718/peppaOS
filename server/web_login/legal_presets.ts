...
export const LEGAL_WEB_LOGIN_PRESETS: WebLoginSitePreset[] = [
  {
    ...
    notes: [
      '法信内容通常受账号授权和服务协议限制。',
      'Peppa 只保存用户授权的本机登录会话，不批量抓取、不共享账号、不绕过验证码或机构访问限制。',
  ...
  },
  {
    ...
    notes: [
      ...
      'Peppa 复用已授权会话做检索阅读，不绕过反爬、验证码、访问频控或下载限制。',
    ].join(' '),
  },
  {
    ...
    notes: [
      ...
      'Peppa 只负责打开页面、复用用户授权会话、辅助形成检索词和来源登记。',
  ...
  },
  {
    ...
    notes: [
      ...
      'Peppa 可以辅助打开页面、准备填写清单和材料组卷，但提交、签名、缴费、撤回等动作必须由律师或当事人亲自确认。',
  ...
  },
  {
    ...
    notes: [
      ...
      'Peppa 可以复用用户授权网页会话，辅助查询公司基本信息、股东信息和风险线索。',
  ...
  },
  {
    ...
    notes: [
      ...
      '该站点可能存在地区跳转、验证码或访问频控，Peppa 只做授权会话复用和检索辅助。',
  ...
  },
  {
    ...
    notes: [
      ...
      'Peppa 不复制平台数据，只打开授权页面、辅助检索、整理来源登记和律师确认后的摘录。',
  ...
  },
  {
    ...
    notes: [
      ...
      'Peppa 只保存本机授权会话并辅助打开检索页面，不批量抓取、不共享账号、不绕过平台限制。',
