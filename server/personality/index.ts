...
export { createDefaultEmotionalState, loadEmotionalState, saveEmotionalState, updateEmotionalState, formatEmotionalStateForPrompt, resolveVerbosityFromState, applyIntimacyToVector, vectorMemoryBias } from './state';
