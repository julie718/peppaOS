...
import { formatPeppaConstitutionForPrompt } from './constitution';
...
export function generateSystemPrompt(
  ...
  blocks.push(formatPeppaConstitutionForPrompt());
  ...
  // Execution modes — Peppa's internal thinking-mode presets
